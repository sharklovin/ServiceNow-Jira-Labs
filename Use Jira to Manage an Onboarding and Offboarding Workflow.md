...
<img width="1065" height="534" alt="SUP1-9 showing Done status and the AD account completion note as an internal note in the activity section" src="screenshots/06_subtask_done_with_note.png" />
